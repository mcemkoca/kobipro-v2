...
export async function getInvoices(): Promise<Invoice[]> {
  ...
  const invoices: Invoice[] = [
    ...
    },
    {
      ...
      total: 211.75,
      status: "OVERDUE",
      notes: "2. hatırlatma gönderildi",
    },
    {
      id: "inv-005",
      invoiceNumber: "CF-2026-005",
    ...
    },
    {
      ...
      status: "PAID",
      paymentMethod: "Kredi Kartı",
      paidDate: dateOffset(-2),
    },
    {
      id: "inv-007",
      invoiceNumber: "CF-2026-007",
      customer: CUSTOMERS[6].name,
    ...
    {
      id: "inv-008",
      invoiceNumber: "CF-2026-008",
      customer: CUSTOMERS[7].name,
      ...
      total: 102.85,
      status: "OVERDUE",
      notes: "Müşteri iletişime geçilecek",
    },
    {
      id: "inv-009",
      invoiceNumber: "CF-2026-009",
      customer: CUSTOMERS[8].name,
    ...
    {
      id: "inv-010",
      invoiceNumber: "CF-2026-010",
      customer: CUSTOMERS[9].name,
    ...
    },
    {
      ...
      status: "PAID",
      paymentMethod: "Kredi Kartı",
      paidDate: dateOffset(-7),
    },
    {
      id: "inv-013",
      invoiceNumber: "CF-2026-013",
      customer: CUSTOMERS[5].name,
      email: CUSTOMERS[5].email,
      service: SERVICES[1],
      date: dateOffset(-1),
