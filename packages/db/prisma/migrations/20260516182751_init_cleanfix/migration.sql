-- CreateEnum
CREATE TYPE "roles" AS ENUM ('ADMIN', 'MANAGER', 'EMPLOYEE', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "booking_statuses" AS ENUM ('PENDING', 'CONFIRMED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "invoice_statuses" AS ENUM ('DRAFT', 'SENT', 'PAID', 'OVERDUE', 'CANCELLED');

-- CreateEnum
CREATE TYPE "payment_methods" AS ENUM ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'ONLINE');

-- CreateEnum
CREATE TYPE "payment_statuses" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED');
...
CREATE TABLE "payments" (
    ...
    "amount" DECIMAL(65,30) NOT NULL,
    "method" "payment_methods" NOT NULL DEFAULT 'CASH',
